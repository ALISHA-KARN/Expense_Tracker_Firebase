      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/deshboard"
            element={
              <PrivateRoutes user={user} component={Dashboard} alt={Signup} />
            }
          />
          <Route
            path="/updateprofile"
          ...
          <Route
            path="/userdetails"
            element={
              <PrivateRoutes user={user} component={UserDetails} alt={Login} />
            }
          />
          <Route
            path="/addexpense"
            element={
              <PrivateRoutes user={user} component={AddExpense} alt={Login} />
            }
          />
          <Route
